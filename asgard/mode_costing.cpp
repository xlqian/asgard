...
static Options make_default_directions_options() {
...
static const Options default_directions_options = make_default_directions_options();

static Options
make_costing_option(const std::string& mode, float speed) {
    Options options = default_directions_options;
    speed *= 3.6;
